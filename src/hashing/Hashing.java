...
//            {
                ...
                hashtable.insert(englishWord,frenchWord);
//                break;
//            }
            //System.out.println("");
        }
        ...
        System.out.println("1\tInsert a new word(english,french)");
        System.out.println("2\tTranslate a phase in Englsih to French");
        System.out.println("3\tWord Count of dictionary");
        System.out.println("4\tWords List");
        System.out.println("5\tTest this program with sentences in test.txt");
        
        while(true) 
        {
            System.out.print("Functio No. (1-4, else exit) : ");
            ...
            switch(val)
            {
                case 1:
                {
                    ...
                    hashtable.insert(engWord,freWord);
                    System.out.println();
                }
                break;
                case 2:
